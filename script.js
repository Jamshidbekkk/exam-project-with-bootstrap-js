//! Fetch games and populate the list
const fetchGames = () => {
...
// ! Sort By function sorting games based on criteria

// const sortByCriteria = async (criteria) => {
//     const gameList = document.getElementById("gameList");
//     gameList.innerHTML = ""; 

//     try {
//         let apiUrl = `https://api.rawg.io/api/games?key=460cd17137bd4114915dfd76478c1ba7&ordering=${criteria}`;
